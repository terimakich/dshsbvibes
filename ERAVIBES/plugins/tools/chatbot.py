...
async def chatbot(_:Client,message:Message):
    ...
    if response.status_code == 200:
        ...
        return await message.reply_text("ChatBot Error: API server error. Contact us at @CodeSearchDev. ")
    else:
        return await message.reply_text("ChatBot Error: Unknown Error Occurred. Contact us at @CodeSearchDev.")
