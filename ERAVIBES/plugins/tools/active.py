...
@app.on_message(filters.command(["activevoice","activevc", "avc"], prefixes=["/", "!", ".", ""]) & SUDOERS)
...
@app.on_message(filters.command(["activevideo","activevd", "av"], prefixes=["/", "!", ".", ""]) & SUDOERS)
...
@app.on_message(filters.command(["ac"], prefixes=["/", "!", ".", ""]) & SUDOERS)
